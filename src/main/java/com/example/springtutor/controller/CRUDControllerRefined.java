...
//    }
    ...
    // --- READ (All Items By Demo) ---
    @GetMapping("/getbydemo")
    public ResponseEntity<List<Item>> getAllItemsByDemo() {
        return ResponseEntity.ok(itemServiceAnalysis.getAllItemsByDemo());
    }
